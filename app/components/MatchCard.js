...
export default function MatchCard({ matchId, live, teamOne, teamTwo, teamOneScore, teamTwoScore, teamOneWicket, teamTwoWicket, progress }) {
    return (
        <Link href={{
            pathname: "/scorecard/[id]",
            params: { id: matchId }
        }}
        className='mr-2.5 flex-1'
        >
            <View style={shadow} className='bg-[#FFFFFF] p-4 rounded-md flex-1 w-[300px] mr-2.5'>
